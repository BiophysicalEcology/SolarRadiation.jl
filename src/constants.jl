# Index permutation matrices for computing Chandrasekhar C₀ and C₁ coefficients
const CHANDRASEKHAR_C0_INDICES = reshape(Int[
        3, 4, 1, 2,
        2, 4, 1, 3,
        2, 3, 1, 4,
        1, 4, 2, 3,
...
const CHANDRASEKHAR_C1_INDICES = reshape(Int[
        2, 3, 4, 1,
        1, 3, 4, 2,
        1, 2, 4, 3,
        1, 2, 3, 4,
...
const DEFAULT_RAYLEIGH_OPTICAL_DEPTH = [
...
const DEFAULT_OZONE_OPTICAL_DEPTH = [
...
const DEFAULT_AEROSOL_OPTICAL_DEPTH = [0.269904738, 0.266147825, 0.262442906, 0.258789404, 0.255186744, 0.251634356, 0.248131676, 0.2412732,
