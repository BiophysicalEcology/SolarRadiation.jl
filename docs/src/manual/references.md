...
atmosphere. Meteorological Monographs 7(29). American Meteorological Society. (Cited as 1967 in some
references.)

Dave JV, Warten RM (1968) Program for computing the Stokes parameters of the radiation emerging from a plane-parallel,
non-absorbing, Rayleigh atmosphere. IBM Scientific Center, Palo Alto, California.

Diem K (ed.) (1966) *Documenta Geigy Scientific Tables*, 6th edition. Geigy, Basel.

Dozier J, Bruno J, Downey P (1981) A faster solution to the horizon problem. Computers and Geosciences 7: 145-151.

Elterman L (1968) UV, visible and IR attenuation for altitudes to 59 km. Air Force Cambridge Research Laboratory, Bedford, Massachusetts.

Elterman L (1970) Vertical-attenuation model with eight surface meteorological ranges 2 to 13 kilometers. Air Force Cambridge
...
Kearney MR, Porter WP (2017) NicheMapR - an R package for biophysical modelling: the microclimate model. Ecography 40: 664-674.
